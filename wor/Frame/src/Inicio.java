...
//	System.out.println("PASE Copiar");
//	Buscar archivos y compilarlos
	...
	System.out.println("PASE Listar archiv cant: "+lista.size() );
	
	AnalizadorJava.compilar(lista, conf.carpetaDestinoBIN());
	
//	System.out.println("PASE MITAD");
//		Cada archivo class
...
//		genero los archivos requeridos
		...
		System.out.println("PASE Procesar");
	}
	System.out.println("PASE ANALIZAR");
}
